...
import { AnimatedBeam } from "@/registry/magicui/animatedbeam"
...
export default function BeamInput({ className }: { className?: string }) {
  ...
  // Add this state to track if the component is mounted
  const [isMounted, setIsMounted] = useState(false)

  // Add this useEffect to set isMounted to true after the component mounts
  useEffect(() => {
    setIsMounted(true)
    return () => setIsMounted(false)
  }, [])

  // Then modify the return statement to only render AnimatedBeam components when mounted
  return (
    <div
      className={cn(
...
const Icons = {
  privacy: () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path d="m19.521 5.893 4.186-4.186A1 1 0 0 0 22.293.293l-4.424 4.424A11.277 11.277 0 0 0 12 3C6.5 3 2.057 7.311.091 11.582a1.008 1.008 0 0 0 0 .836 16.4 16.4 0 0 0 4.388 5.689L.293 22.293a1 1 0 1 0 1.414 1.414l4.424-4.424A11.274 11.274 0 0 0 12 21c5.5 0 9.942-4.311 11.908-8.582a1 1 0 0 0 0-.836 16.411 16.411 0 0 0-4.387-5.689ZM2.11 12C3.854 8.552 7.589 5 12 5a9.111 9.111 0 0 1 4.394 1.192l-1.641 1.641a4.992 4.992 0 0 0-6.92 6.92l-1.922 1.922A14.483 14.483 0 0 1 2.11 12ZM15 12a3 3 0 0 1-3 3 2.951 2.951 0 0 1-1.285-.3l3.985-3.985A2.951 2.951 0 0 1 15 12Zm-6 0a3 3 0 0 1 3-3 2.951 2.951 0 0 1 1.285.3L9.3 13.285A2.951 2.951 0 0 1 9 12Zm3 7a9.108 9.108 0 0 1-4.394-1.192l1.641-1.641a4.992 4.992 0 0 0 6.92-6.92l1.922-1.922A14.483 14.483 0 0 1 21.89 12c-1.744 3.448-5.48 7-9.89 7Z" />
    </svg>
  ),
  blockchain: () => (
    <svg
    ...
    >
      <path
        ...
        stroke-width="3.353"
        d="m94.355 88.496 21.93 12.675M116.285 60.262l-21.93 12.675M80.875 47.452V65.09M80.875 96.342v16.632M116.352 60.262V49.129l-21.93-12.675v3.822l-13.547 7.78-13.547-7.78v-3.89l-21.93 12.676v11.2l-9.724 5.633v29.777l9.724 5.566v11.066l21.93 12.675v-4.225l13.547-7.779 13.547 7.779v4.091l21.93-12.608v-10.999l9.524-5.499V65.761l-9.524-5.5ZM67.328 88.496l-21.863 12.675M44.19 59.525l23.138 13.346"
      />
      <path
        stroke="#000"
        stroke-miterlimit="10"
        stroke-width="3.353"
        d="m94.422 120.754-13.547-7.78-13.547 7.78v15.693l13.547 7.779 13.547-7.779v-15.693Z"
      />
      <path
        stroke="#000"
        stroke-miterlimit="10"
        stroke-width="3.353"
        d="m94.422 120.754-13.547 7.847-13.547-7.847M80.875 144.227v-15.626M45.397 44.638l-13.48-7.78-13.547 7.78v15.626l13.547 7.847 13.48-7.847V44.638Z"
      />
      <path
        stroke="#000"
        stroke-miterlimit="10"
        stroke-width="3.353"
        d="m45.397 44.635-13.48 7.847-13.547-7.847M31.918 68.108V52.48M116.353 44.638l13.48-7.78 13.547 7.78v15.626l-13.547 7.847-13.48-7.847V44.638Z"
      />
      <path
        stroke="#000"
        stroke-miterlimit="10"
        stroke-width="3.353"
        d="m116.353 44.635 13.48 7.847 13.547-7.847M129.833 68.108V52.48M45.397 101.24l-13.48-7.78-13.547 7.78v15.626l13.547 7.847 13.48-7.847V101.24Z"
      />
      <path
        stroke="#000"
        stroke-miterlimit="10"
        stroke-width="3.353"
        d="m45.397 101.238-13.48 7.846-13.547-7.846M31.918 124.71v-15.626M116.353 101.24l13.48-7.78 13.547 7.78v15.626l-13.547 7.847-13.48-7.847V101.24Z"
      />
      <path
        stroke="#000"
        stroke-miterlimit="10"
        stroke-width="3.353"
        d="m116.353 101.238 13.48 7.846 13.547-7.846M129.833 124.71v-15.626M94.422 24.65l-13.547-7.846-13.547 7.847v15.626l13.547 7.78 13.547-7.78V24.65Z"
      />
      <path
        stroke="#000"
        stroke-miterlimit="10"
        stroke-width="3.353"
        d="m94.422 24.65-13.547 7.78-13.547-7.78M80.875 48.057V32.43M94.422 72.939l-13.547-7.847-13.547 7.847v15.626l13.547 7.78 13.547-7.78V72.939Z"
      />
      <path
        stroke="#000"
        stroke-miterlimit="10"
        stroke-width="3.353"
        d="m94.422 72.939-13.547 7.779-13.547-7.78M80.875 96.341V80.715"
      />
    </svg>
  ),
  notion: () => (
